-- shift_licenses inherits its access scope from the related shift.
...
DROP POLICY IF EXISTS
  "Authenticated users can delete shift licenses"
  ON public.shift_licenses;
...
CREATE POLICY
  ...
  USING (
    EXISTS (
      ...
      WHERE shift.id = shift_licenses.shift_id
...
DROP POLICY IF EXISTS
  "Authenticated users can manage shift licenses"
  ON public.shift_licenses;
...
DROP POLICY IF EXISTS
  "Authenticated users can view shift licenses"
  ON public.shift_licenses;
